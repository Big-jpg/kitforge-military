        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-stone-300">
            <p className="text-xl text-stone-400 leading-relaxed">
              ...
              innovative precision-engineered kit cards that combine detailed craftsmanship with
              accessible assembly.
            </p>
            ...
            <p>
              ...
              precision-manufactured and ready to assemble, making detailed military vehicles
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Flat Pack Design:</strong> All parts arrive on a single card-sized sprue,
                ready for assembly
              </li>
              <li>
            ...
            <p>
              All our designs are created in-house by experienced designers and military
              enthusiasts. We hold commercial licenses for our designs and ensure that each kit
              meets our high standards for quality, accuracy, and assembly experience.
            </p>
            ...
            <div className="mt-8 p-6 bg-stone-900 border border-stone-800 rounded-lg">
              <p className="text-center text-stone-400">
                ...
                <br />
                Browse our catalog and order your first kit today.
              </p>
            </div>
          </div>
        </div>
