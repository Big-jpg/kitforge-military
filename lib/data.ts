...
export const products: KitProduct[] = [
  {
    ...
    longDescription:
      "The Lockheed Martin F-22 Raptor is a fifth-generation, single-seat, twin-engine, stealth tactical fighter aircraft. This kit card features incredible detail including movable control surfaces, landing gear, and display stand. Perfect for aviation enthusiasts and collectors.",
    difficulty: "advanced",
    partsCount: 47,
    printTimeEstimateHours: 8,
    images: [
