...
export function SiteFooter() {
  return (
    <footer className="border-t border-stone-700 bg-stone-900 text-stone-400 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">
              Premium 3D-printed military kit cards for makers and collectors.
            </p>
          </div>
          ...
          {/* Social */}
          <div>
            <h3 className="font-semibold text-stone-100 mb-4">Connect</h3>
        ...
        <div className="mt-8 pt-8 border-t border-stone-800 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} KitForge Military. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
